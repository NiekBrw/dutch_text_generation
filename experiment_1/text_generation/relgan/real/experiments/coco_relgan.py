...
# Paths
rootdir = '../..'
scriptname = 'main_run.py'
cwd = os.path.dirname(os.path.abspath(__file__))

outdir = os.path.join(cwd, 'out', time.strftime("%Y%m%d"), dataset, 'test',
...
args = [
    ...
    '--start-token', '0',
    '--seq-len', seq_len,
    '--num-sentences', '100',  # how many generated sentences to use per evaluation
...
print("RelGAN took", time.time() - start_time, "to run")